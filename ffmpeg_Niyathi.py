...
#variables to change
date = '4-13-23'    #date folder
video_1_name = "Basler acA2440-35um (22467982)_20230413_115816232.mp4"     #include .avi or .m4v
...
video_1_path = '/oak/stanford/groups/trc/data/niyathi/timing/clk[out]data/' + str(date) +'/'   #path to video 1, should end in /
