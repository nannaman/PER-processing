...
#variables to change
date = '12-16-22'    #date folder
video_1_name = "Basler acA2440-35um (22467982)_20221216_161200324.mp4"     #include .avi or .m4v
...
video_1_path = '/oak/stanford/groups/trc/data/niyathi/timing/tim[01]data/' + str(date) +'/'   #path to video 1, should end in /
