...
#variables to change
date = '3-27-23 II'    #date folder
video_1_name = "Basler acA2440-35um (22467982)_20230327_180517856.mp4"     #include .avi or .m4v
...
video_1_path = '/oak/stanford/groups/trc/data/niyathi/timing/cyc[01]/' + str(date) +'/'   #path to video 1, should end in /
