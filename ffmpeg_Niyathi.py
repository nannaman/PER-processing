...
#variables to change
date = '3-10-23'    #date folder
video_1_name = "Basler acA2440-35um (22467982)_20230310_173618287.mp4"     #include .avi or .m4v
...
video_1_path = '/oak/stanford/groups/trc/data/niyathi/timing/rover-sitterdata/sitter_fed/' + str(date) +'/'   #path to video 1, should end in /
